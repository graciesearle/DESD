...
urlpatterns = [
    ...
    path(
        ...
        views.admin_commissions_csv,
        name="admin_commissions_csv",
    ),
    path(
        "admin-commissions/export/accounting/",
        views.admin_commissions_accounting_csv,
        name="admin_commissions_accounting_csv",
    ),
    path(
        "admin-commissions/<str:order_number>/",
        views.admin_commissions_detail,
        name="admin_commissions_detail",
    ),
    # producer payouts
