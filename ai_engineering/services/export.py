        ...
        for inference in queryset.order_by("id"):
            ...
            csv_writer.writerow(
                [
                    ...
                    latest_override.color_accepted if latest_override else "",
                    latest_override.size_accepted if latest_override else "",
                    latest_override.ripeness_accepted if latest_override else "",
                    latest_override.override_color_score if latest_override else "",
                    latest_override.override_size_score if latest_override else "",
                    latest_override.override_ripeness_score if latest_override else "",
