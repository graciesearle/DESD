...
class ProductAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.farm = Farm.objects.create(
            producer=self.user, name="Test Farm", postcode="BS1 1AA"
        )
...
class CustomerCannotCRUDTest(TestCase):
    ...
    def setUp(self):
        ...
        self.farm = Farm.objects.create(
            producer=self.producer, name="Test Farm", postcode="BS1 1AB"
        )
...
class ProducerOwnershipTest(TestCase):
    ...
    def setUp(self):
        ...
        self.farm_a = Farm.objects.create(
            producer=self.producer_a, name="Farm A", postcode="BS1 1AC"
        )
